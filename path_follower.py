...
class PathFollower(Solver):
    ...
    def solve_path(
        ...
        return self.solve(P, self._F[self.JP_knn.kneighbors(np.column_stack([J, P]), return_distance=False).flatten()], num_sols=num_traj, return_numpy=return_numpy)  # type: ignore
